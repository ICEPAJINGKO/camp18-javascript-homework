...
if (cusName in employees) {
    alert(`Name: ${cusName}, salary: ${employees[cusName].salary}, address: ${employees[cusName].address.district}, ${employees[cusName].address.province}`);
} else {
    alert("Not Found");
}
